...
init([]) ->
    ...
    Seq = {ecas_seq,
           {ecas_seq_server, start_link, []},
           permanent, 5000, worker, [ecas_seq_server]},
    TStore = {ecas_tstore,
              {ecas_tstore_server, start_link, []},
              permanent, 5000, worker, [ecas_tstore_server]},
    Processes = [Seq, TStore, Web],
